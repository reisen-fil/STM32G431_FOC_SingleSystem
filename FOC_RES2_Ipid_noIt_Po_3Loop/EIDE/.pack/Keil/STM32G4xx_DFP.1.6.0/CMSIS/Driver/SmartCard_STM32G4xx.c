...
\section stm32g4_usart_smart_history History
...
\section stm32g4_usart_smart_instances Instances
...
\section stm32g4_usart_smart_limitations Limitations
...
static int32_t SMARTCARD_Control (     uint32_t              control,
  ...
  switch (control & ARM_USART_FLOW_CONTROL_Msk) {
    case ARM_USART_FLOW_CONTROL_NONE:
      smartcard->h->Init.HwFlowCtl = UART_HWCONTROL_NONE;
      break;
