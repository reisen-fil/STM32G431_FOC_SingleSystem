...
\section stm32g4_usart_irda_history History

- Version 1.1
  - Version synchronized with USART driver component version
- Version 1.0
  - Initial release

\section stm32g4_usart_irda_instances Instances

Hardware resource relating to CMSIS-Driver instance is shown in the table below:
...
static int32_t IRDA_Control (      uint32_t         control,
  ...
  switch (control & ARM_USART_STOP_BITS_Msk) {
    case ARM_USART_STOP_BITS_1:
      irda->h->Init.StopBits = UART_STOPBITS_1;
      break;
  ...
  switch (control & ARM_USART_FLOW_CONTROL_Msk) {
    case ARM_USART_FLOW_CONTROL_NONE:
      irda->h->Init.HwFlowCtl = UART_HWCONTROL_NONE;
      break;
